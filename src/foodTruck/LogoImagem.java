...
public class LogoImagem {
	...
	//public static ImageIcon areaRestrita(){
		//URL url = Janela0ModeloJanelaParaTodos.class.getResource("/recurso/restrito.png");
	   // ImageIcon imagemRestrita = new ImageIcon(url);
	    //return imagemRestrita;
	//}
}
